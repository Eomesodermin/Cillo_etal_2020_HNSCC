...
Raw data is **not** stored here — download from GEO: [GSE139324](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE139324) into the data directory. Processed objects are regenerated by the pipeline.
